...
| Config | Acc | QED | FPDiv | 论文 RapTB |
|--------|-----|-----|-------|-----------|
| β=1,ρ=0 | 0.992 | 0.751 | 0.849 | |
| β=1,ρ=0.1 | 0.994 | 0.744 | 0.857 | |
| β=1,ρ=0.5 | 0.992 | 0.748 | 0.860 | |
| β=5,ρ=0 | 0.995 | 0.795 | 0.855 | |
| **β=5,ρ=0.1** | **0.991** | **0.783** | **0.864** | **Acc=0.996, QED=0.740, FPDiv=0.860** |
| β=5,ρ=0.5 | 0.997 | 0.800 | 0.865 | |
| β=10,ρ=0 | 0.968 | 0.727 | 0.883 | |
| β=10,ρ=0.1 | 0.999 | 0.804 | 0.854 | |
| β=10,ρ=0.5 | 0.997 | 0.794 | 0.863 | |

**结论**: Acc 8/9 ≥ 0.991, QED 0.727-0.804 (论文 0.740 在范围内), FPDiv 0.849-0.883 (论文 0.860 在中心)。方法 robust。
...
| 任务 | AvgPrefixTB | RapTB/RapTB+SubM | 差距 |
|------|------------|-----------------|------|
| Expr24 NormCov | 0.016 | 0.039 | -59% |
| SMILES QED | 0.661 | 0.844 | -22% |
| SMILES Len | 2.89 (坍缩) | 7.44 | — |

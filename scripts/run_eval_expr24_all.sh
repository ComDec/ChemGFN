...
# baseline
# python eval.py experiment="VarExpr24/VarExpr24_TB_no_data_buffer_hit" exp_name="VarExpr24_TB" +trainer.limit_test_batches=200 ckpt_path="/data1/xw3763/project/gflow/ChemGFN/logs/train/VarExpr24_CFG_TB_hit24_dense/train/runs/2026-01-13_09-08-36/checkpoints/last.ckpt" test_repeats=3
# python eval.py experiment="VarExpr24/VarExpr24_SubTB_no_data_buffer_hit" exp_name="VarExpr24_SubTB" +trainer.limit_test_batches=200 ckpt_path="/data1/xw3763/project/gflow/ChemGFN/logs/train/VarExpr24_CFG_SubTB_no_data_buffer_hit24_dense/train/runs/2026-01-13_09-08-56/checkpoints/last.ckpt" test_repeats=3
...
# Oracle
# python eval.py experiment="VarExpr24/VarExpr24_TB_no_data_buffer_hit_oracle" exp_name="VarExpr24_TB_Oracle" +trainer.limit_test_batches=200 ckpt_path="/data1/xw3763/project/gflow/ChemGFN/logs/train/VarExpr24_CFG_TB_hit24_dense_oracle/train/runs/2026-01-13_09-11-34/checkpoints/last.ckpt" test_repeats=3
...
# PRT variants
# python eval.py experiment="VarExpr24/VarExpr24_TB_no_data_buffer_hit_PRT" exp_name="VarExpr24_TB_PRT" +trainer.limit_test_batches=200 ckpt_path="/data1/xw3763/project/gflow/ChemGFN/logs/train/VarExpr24_CFG_TB_hit24_dense_PRT/train/runs/2026-01-21_07-22-37/checkpoints/last.ckpt" test_repeats=3

SMILES_PROMPTS_AHEAD = "You must follow the following rules to generate SMILES:\
1. **Basic Structure:**\
...
IUPAC_PROMPTS_EXAMPLES = "There are several examples to convert IUPAC names into SMILES notation.\
...
SMILES_PROMPTS_BEHIND = "You must give only one SMILES string as output without any additional information, explanation, context, and characters. According to the following"
